...
class module:
    ...
    def pipe_reaction(num1, num2, num3, num4, num5, num6, num7, arr1, arr2):
        ...
        net_delta_chlorine_reac = -delta_chlorine_toc_reac_pipe - delta_chlorine_wall_reac_pipe - delta_chlorine_pfoab_reac_pipe \
        ...
        delta_mat = [net_delta_chlorine_reac, net_delta_toc_reac, net_delta_pfoab_reac, net_delta_pfoaams_reac, net_delta_pfoa_reac]
        return delta_mat
    ...
    def tank_reaction(num1, num2, num3, num4, num5, arr1, arr2, arr3):
        ...
        delta_chlorine_toc_reac_tank = (num4/ num5) * module.first_order_reaction(KbNC, tank_chlorine_conc, num1)
        delta_toc_chlorine_reac_tank = YN * delta_chlorine_toc_reac_tank
        delta_pfoab_chlorine_reac_tank = (num4/ num5) * module.first_order_reaction(KbCP1, tank_pfoab_conc, num1)
        delta_pfoaams_chlorine_reac_tank = (num4/ num5) * module.first_order_reaction(KbCP2, tank_pfoaams_conc, num1)
        ...
        net_delta_chlorine_reac = -delta_chlorine_toc_reac_tank - delta_chlorine_pfoab_reac_tank - delta_chlorine_pfoaams_reac_tank
