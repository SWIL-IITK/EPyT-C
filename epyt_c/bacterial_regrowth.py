...
class module:
    ...
    def species():
        msrt_info = []
        number_water_quality_parameters = 5; msrt_info.append(number_water_quality_parameters)
        number_bulk_water_quality_parameters = 5; msrt_info.append(number_bulk_water_quality_parameters)
    ...
    def variables(num1, num2):
        ...
        if num1 == 1:
            ...
            for x in range(num1):                   
                ...
                variable_mat[x][4] = random.uniform(math.log(umax_lower), math.log(umax_upper)) * math.exp(-((37 - variable_mat[x][0])/ 30)**2)
    ...
    def pipe_reaction(num1, num2, num3, num4, num5, num6, num7, arr1, arr2):
        ...
        kbNC = arr1[1]; kwC = arr1[2]; YN = arr1[3]; umax = arr1[4]; Ks = arr1[5]; kin = arr1[6]
        kd = arr1[7]; kcd = arr1[8]; klys = arr1[9]; Y = arr1[10]; a = arr1[11]; b = arr1[12]
        Dm_chlorine = arr1[13]; nu_water = arr1[18]
        ...
        net_delta_chlorine_reac = -delta_chlorine_rdoc_reac_pipe -delta_chlorine_bdoc_reac_pipe - \
            delta_chlorine_wall_reac_pipe
        net_delta_rdoc_reac = -delta_rdoc_chlorine_reac_pipe
        net_delta_bdoc_reac = -delta_bdoc_chlorine_reac_pipe - delta_bdoc_consumption_pipe + \
        ...
        delta_mat = [net_delta_chlorine_reac, net_delta_rdoc_reac, net_delta_bdoc_reac, net_delta_flb_reac,\
                     net_delta_fdb_reac]
        return delta_mat
    ...
    def tank_reaction(num1, num2, num3, num4, num5, arr1, arr2, arr3):
        ...
        kbNC = arr1[1]; YN = arr1[3]; umax = arr1[4]; Ks = arr1[5]; kin = arr1[6]; kd = arr1[7]
        kcd = arr1[8]; klys = arr1[9]; Y = arr1[10]; a = arr1[11]; b = arr1[12]
        
        if num2 == 1:
            tank_chlorine_conc = arr2[num3][0]; tank_rdoc_conc = arr2[num3][1]; tank_bdoc_conc = arr2[num3][2]
            tank_flb_conc = arr2[num3][3]; tank_fdb_conc = arr2[num3][4]
        else:
            tank_chlorine_conc = arr3[0][num2 - 1][num3]; tank_rdoc_conc = arr3[1][num2 - 1][num3]
            tank_bdoc_conc = arr3[2][num2 - 1][num3]; tank_flb_conc = arr3[3][num2 - 1][num3]
        ...
        delta_chlorine_rdoc_reac_tank = (num4/ num5) * module.first_order_reaction(KbNC, tank_chlorine_conc, num1)
        delta_chlorine_bdoc_reac_tank = (num4/ num5) * module.first_order_reaction(KbSC, tank_chlorine_conc, num1)
        ...
        net_delta_bdoc_reac = -delta_bdoc_chlorine_reac_tank - delta_bdoc_consumption_tank + \
