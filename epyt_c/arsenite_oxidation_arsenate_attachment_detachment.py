...
class module:
    ...
    def species():
        msrt_info = []
        number_water_quality_parameters = 6; msrt_info.append(number_water_quality_parameters)
        number_bulk_water_quality_parameters = 5; msrt_info.append(number_bulk_water_quality_parameters)
        number_wall_water_quality_parameters = 1; msrt_info.append(number_wall_water_quality_parameters)
    ...
    def pipe_reaction(num1, num2, num3, num4, num5, num6, num7, arr1, arr2):
        ...
        Sorb = (arr2[1][num3][num2]* (S_max - arr2[5][num3][num2]) - k_eq * arr2[5][num3][num2])/ ((1/ k_ads) + \
                                                                                                    ((1/ KfAs)* (S_max - arr2[5][num3][num2])))
        ...
        net_delta_chlorine_reac = -delta_chlorine_toc_reac_pipe - delta_chlorine_wall_reac_pipe - delta_chlorine_As3_reac_pipe
        ...
        delta_mat = [net_delta_As3_reac, net_delta_As5_reac_bulk, net_delta_As_reac, net_delta_chlorine_reac, \
                     net_delta_toc_reac, net_delta_As5_reac_wall]
        return delta_mat
    ...
    def tank_reaction(num1, num2, num3, num4, num5, arr1, arr2, arr3):
        ...
        if (num4/ num5) * module.first_order_reaction(KbCAs, tank_As3_conc, num1) > tank_As3_conc:
            ...
            delta_As3_chlorine_reac_tank= (num4/ num5) * module.first_order_reaction(KbCAs, tank_As3_conc, num1)
        ...
        delta_mat = [net_delta_As3_reac, net_delta_As5_reac, net_delta_As_reac, net_delta_chlorine_reac, \
                     net_delta_toc_reac]
        return delta_mat
