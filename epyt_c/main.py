...
class epyt_c:
    ...
    def __init__(self, module, maximum_iterations_required, network_name, simulation_period_days, simulation_time_step, base_period_days,
        ...
        self.network_name = os.path.join(network_folder, network_name)

        self.maximum_iterations_required = maximum_iterations_required

        self.simulation_period_days = simulation_period_days
