...
plt.plot(c_range, percentage[:, 0], marker = 'o', markersize = 5, markerfacecolor = 'None', markeredgecolor = 'c',\
         linestyle = '--', linewidth = 0.5, color =  'c')
plt.plot(c_range, percentage[:, 1], marker = '^', markersize = 5, markerfacecolor = 'None', markeredgecolor = 'r',\
         linestyle = '--', linewidth = 0.5, color =  'r')
plt.plot(c_range, percentage[:, 2], marker = 'v', markersize = 5, markerfacecolor = 'None', markeredgecolor = 'g',\
             linestyle = '--', linewidth = 0.5, color =  'g')
plt.plot(c_range, percentage[:, 3], marker = 's', markersize = 5, markerfacecolor = 'None', markeredgecolor = 'b',\
