...
plt.plot(x_data, y_data[:, 0], marker = '_', markersize = 2, markerfacecolor = 'None', markeredgecolor = 'c',\
         linestyle = '')
plt.plot(x_data, y_data[:, 2], marker = '_', markersize = 2, markerfacecolor = 'None', markeredgecolor = 'c',\
         linestyle = '')
plt.vlines(x = x_data, ymin = y_data[:, 0], ymax = y_data[:, 2], color = 'c', linestyle = '--', linewidth = 0.2)
plt.plot(x_data, y_data[:, 1], marker = 'o', markersize = 2, markerfacecolor = 'None', markeredgecolor = 'crimson',\
